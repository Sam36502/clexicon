...
<div class="mv3">
    <form on:submit={search} onsubmit="return false;">
        <input type="text" class="f4 ba br2 pv2 ph3 input-reset" bind:value={query}>
        <input type="button" class="f4 ba br2 b--mid-gray pv2 ph4 link dim white bg-mid-gray pointer" value="Search!" on:click={search}>
    </form>
</div>
